...
class EntryTemplates extends Plugin
{
	...
	public function getCpNavItem(): ?array
	{
		...
		// Check if navigation item is allowed on environment
		$config = EntryTemplates::customConfig();

		if ($config) {
			if (isset($config["displayNavigation"]) && !$config["displayNavigation"]) {
				return null;
			}
		}

		// Final check for user permissions
